...
<div class="card">
    <div class="card-header">
        <h1 class="card-title">📥 Stok Masuk</h1>
        <a href="{{ route('stok-masuk.create') }}" class="btn btn-success">+ Tambah</a>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <a href="{{ route('stok-masuk.edit', $sm) }}" class="btn btn-sm btn-warning">✏️</a>
